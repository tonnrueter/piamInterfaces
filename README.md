...
R package **piamInterfaces**, version **0.0.18.9001**
...
Benke F, Richters O (2022). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.0.18.9001, <https://github.com/pik-piam/piam_interfaces>.
...
@Manual{,
  ...
  year = {2022},
  note = {R package version 0.0.18.9001},
