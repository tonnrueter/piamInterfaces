...
R package **piamInterfaces**, version **0.29.3**
...
Benke F, Richters O (2024). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.29.3, <https://github.com/pik-piam/piamInterfaces>.
