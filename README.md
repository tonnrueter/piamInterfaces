...
R package **piamInterfaces**, version **0.0.2**
...
Benke F (2022). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.0.2, <https://github.com/pik-piam/piam_interfaces>.
