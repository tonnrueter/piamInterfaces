...
R package **piamInterfaces**, version **0.0.31**
...
Benke F, Richters O (2022). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.0.31, <https://github.com/pik-piam/piam_interfaces>.
