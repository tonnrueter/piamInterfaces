...
R package **piamInterfaces**, version **0.46.1**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.46.1, <https://github.com/pik-piam/piamInterfaces>.
