...
R package **piamInterfaces**, version **0.0.7**
...
Benke F (2022). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.0.7, <https://github.com/pik-piam/piam_interfaces>.
