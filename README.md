...
R package **piamInterfaces**, version **0.40.0**
...
Benke F, Richters O (2024). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.40.0, <https://github.com/pik-piam/piamInterfaces>.
