...
R package **piamInterfaces**, version **0.40.6**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.40.6, <https://github.com/pik-piam/piamInterfaces>.
