...
R package **piamInterfaces**, version **0.12.8**
...
Benke F, Richters O (2024). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.12.8, <https://github.com/pik-piam/piamInterfaces>.
