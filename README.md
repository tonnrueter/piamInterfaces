...
R package **piamInterfaces**, version **0.39.1**
...
Benke F, Richters O (2024). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.39.1, <https://github.com/pik-piam/piamInterfaces>.
