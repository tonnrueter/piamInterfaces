...
R package **piamInterfaces**, version **0.0.101**
...
Benke F, Richters O (2023). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.0.101, <URL: https://github.com/pik-piam/piamInterfaces>.
