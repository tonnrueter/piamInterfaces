...
R package **piamInterfaces**, version **0.40.9**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.40.9, <https://github.com/pik-piam/piamInterfaces>.

A BibTeX entry for LaTeX users is

 ```latex
@Misc{,
  title = {piamInterfaces: Project specific interfaces to REMIND / MAgPIE - Version 0.40.9},
