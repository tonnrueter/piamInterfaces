...
R package **piamInterfaces**, version **0.0.63**
...
Benke F, Richters O (2023). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.0.63, <https://github.com/pik-piam/piamInterfaces>.
