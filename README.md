...
R package **piamInterfaces**, version **0.20.20**
...
Benke F, Richters O (2024). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.20.20, <URL: https://github.com/pik-piam/piamInterfaces>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 0.20.20},
