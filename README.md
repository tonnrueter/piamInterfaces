...
R package **piamInterfaces**, version **0.0.107**
...
Benke F, Richters O (2023). _piamInterfaces: Project specific interfaces to REMIND / MAgPIE_. R package version 0.0.107, <https://github.com/pik-piam/piamInterfaces>.
...
@Manual{,
  ...
  year = {2023},
  note = {R package version 0.0.107},
