test_that("areUnitsIdentical works", {
  ...
  expect_true(areUnitsIdentical("Million", "mio", "million"))
  expect_true(areUnitsIdentical("Mt/yr", "Mt/year"))
  expect_true(areUnitsIdentical("Mt CO2-equiv/Mt", "Mt CO2/Mt"))
  expect_true(areUnitsIdentical(c("Mt CO2-equiv/yr", "Mt CO2eq/yr", "Mt CO2e/yr", "Mt CO2/yr")))
  expect_true(areUnitsIdentical(c("Percentage", "Percent", "percent", "%"))
  expect_true(areUnitsIdentical(c("tDM/cap/yr", "tDM/capita/yr"))
  expect_true(areUnitsIdentical(c("USD05", "USD2005", "US$05", "US$2005", "USD2005", "USD_2005"))
  expect_true(areUnitsIdentical(c("USD10", "USD2010", "US$10", "US$2010", "USD2010", "USD_2010"))
